...
if play.lower().strip() == "no":
    ...
    time.sleep(3)  
    print("The host reveals that in order to get a HUGE prize you need to answer ALL 10 questions correctly. He also reveals that if you mess up even one question there will be a HUGE punishment. ") 
    time.sleep (5)
    ...
    time.sleep (3)
    print("After the 5th question it became clear that the nerd was absolutely no match for the homeless guy.")
    time.sleep (3)
    print('The 10th question seemed absolutely impossible, "State the first 100 digits of pi." Seemed like an impossible task or so you thought. The homeless guy made it look like he was counting to 100 while the nerd looked like he was going to cry.')
    time.sleep (5)
    ...
    if gameshow_answer.lower().strip() == "yes":
        ...
        time.sleep (5)
        #creates a tally for questions correct 
        questions_correct = 0
        print("")
    ...
    #while loop so that the user does not type in an option that is not valid. for example, if they accidentally hit the keyboard. 
        ...
        print("D. !=")
        print("")
        question_four = input("Which of these is not a comparison operator: ")
    
        #while loop so that the user does not type in an option that is not valid. for example, if they accidentally hit the keyboard. 
    
        while question_four.lower().strip() != "a" and question_four.lower().strip() != "b" and question_four.lower().strip() != "c" and question_four.lower().strip() != "d":
            print("")
            time.sleep(1.5)
            print("Please enter a valid response")
            time.sleep(1.5)
        ...
        if question_four.lower().strip() == ("c"):
            questions_correct += 1
            print("")
            time.sleep(1.5)
            print("Correct!")
        ...
        print("D. iOS")
        print("")
        question_five = input("What is the worlds most popular operating system: ")
    
    #while loop so that the user does not type in an option that is not valid. for example, if they accidentally hit the keyboard. 
    
        while question_five.lower().strip() != "a" and question_five.lower().strip() != "b" and question_five.lower().strip() != "c" and question_five.lower().strip() != "d":
            print("")
            time.sleep(1.5)
            print("Please enter a valid response")
            time.sleep(1.5)
        ...
        print("D. ComHack")
        print("")
        question_six = input("Which of these is not a type of malaware: ")
    
        #while loop so that the user does not type in an option that is not valid. for example, if they accidentally hit the keyboard. 
    
        while question_six.lower().strip() != "a" and question_six.lower().strip() != "b" and question_six.lower().strip() != "c" and question_six.lower().strip() != "d":
            print("")
            time.sleep(1.5)
            print("Please enter a valid response")
            time.sleep(1.5)
        ...
        print("")
        print("A. Rare accumulated memory")
        print("B. Random access memory")
        print("C. Random activated memory")
        print("D. Rare access memory")
        print("")
        question_seven = input("What does RAM stand for: ")
    
    #while loop so that the user does not type in an option that is not valid. for example, if they accidentally hit the keyboard. 
    
        while question_seven.lower().strip() != "a" and question_seven.lower().strip() != "b" and question_seven.lower().strip() != "c" and question_seven.lower().strip() != "d":
            print("")
            time.sleep(1.5)
            print("Please enter a valid response")
            time.sleep(1.5)
        ...
        if question_seven.lower().strip() == ("b"):
            questions_correct += 1
            print("")
            time.sleep(1.5)
            print("Correct!")
        ...
        print("D. whole")
        print("")
        question_eight = input("Which of these is not a data type: ")
    
    #while loop so that the user does not type in an option that is not valid. for example, if they accidentally hit the keyboard. 
    
        while question_eight.lower().strip() != "a" and   question_eight.lower().strip() != "b" and question_eight.lower().strip() != "c" and       question_eight.lower().strip() != "d":
            print("")
            time.sleep(1.5)
            print("Please enter a valid response")
            time.sleep(1.5)
        ...
        if question_eight.lower().strip() == ("d"):
            questions_correct += 1
            print("")
            time.sleep(1.5)
            print("Correct!")
        ...
        print("D. %")
        print("")
        question_nine = input("Which of these is not a mathematical operator: ")
    
        #while loop so that the user does not type in an option that is not valid. for example, if they accidentally hit the keyboard. 
    
        while question_nine.lower().strip() != "a" and   question_nine.lower().strip() != "b" and question_nine.lower().strip() != "c" and       question_nine.lower().strip() != "d":
            print("")
            time.sleep(1.5)
            print("Please enter a valid response")
            time.sleep(1.5)
        ...
        if question_nine.lower().strip() == ("a"):
            questions_correct += 1
            print("")
            time.sleep(1.5)
            print("Correct!")
        ...
        print("")
        print("A. Syntax/Compilation")
        print("B. Run-time")
        print("C. Real-time")
        print("D. Logical")
        print("")
        question_ten = input("Which of these is not a type of error in python: ")
    
        #while loop so that the user does not type in an option that is not valid. for example, if they accidentally hit the keyboard. 
    
        while question_ten.lower().strip() != "a" and   question_ten.lower().strip() != "b"   and question_ten.lower().strip() != "c" and question_ten.lower().strip() != "d":
            print("")
            time.sleep(1.5)
            print("Please enter a valid response")
            time.sleep(1.5)
